...
summary_coverage_fe <- summarize_coverage_fe(res_fe, grouping_vars = c("model_name", "bs_type"))
...
ggsave(
  file.path(dir_figures, "ts_bh_linePlots.png"),
  plot = final_plot,
  width = 12,
  height = 16,
  dpi = 300
...
## bias and rmse over time for 0->1 and 0->3 transitions ----
...
writeLines(latex_coverage_bh, file.path(dir_tables, "tsbh-coverage.tex"))

## fe coverage table ----
latex_coverage_fe <- generate_coverage_latex_fe(summary_coverage_fe)
